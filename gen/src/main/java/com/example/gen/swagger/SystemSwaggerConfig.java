...
package com.example.gen.swagger;
...
public class SystemSwaggerConfig {
    ...
    public Docket groupRestApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.example.gen.controller"))
...
//                .securitySchemes(CollectionUtils.<SecurityScheme>newArrayList(apiKey(), apiKey1()));
    ...
    private ApiInfo groupApiInfo() {
        return new ApiInfoBuilder()
                .title("代码生成")
                .description("<div style='font-size:14px;color:red;'>代码生成</div>")
