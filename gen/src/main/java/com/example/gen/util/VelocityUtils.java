...
public class VelocityUtils {
    ...
    public static VelocityContext prepareContext(GenTable genTable) {
        ...
        velocityContext.put("databaseName" , genTable.getDatabaseName());
        ...
        velocityContext.put("datetime" , DateTimeFormatter.ofPattern(Constants.DATE_TIME_FORMAT).format(LocalDateTime.now()));
