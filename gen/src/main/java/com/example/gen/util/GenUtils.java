...
import com.example.gen.config.GenConfig;
...
public class GenUtils {
    ...
    public static void initColumnField(GenTableColumn column, GenTable table) {
        ...
        // 设置java字段名
        column.setJavaField(columnName.contains("_") ? StringUtils.toCamelCase(columnName) : columnName);
        // 设置默认类型
        ...
        if (arraysContains(GenConstants.COLUMNTYPE_STR, dataType) || arraysContains(GenConstants.COLUMNTYPE_TEXT, dataType)) {
        ...
        } else if (arraysContains(GenConstants.COLUMNTYPE_TIME_LOCALDATETIME, dataType)) {
            ...
            column.setJavaType(GenConstants.TYPE_LOCAL_TIME);
            column.setHtmlType(GenConstants.HTML_DATETIME);
